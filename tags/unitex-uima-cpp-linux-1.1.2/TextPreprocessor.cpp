...
namespace unitexcpp
{
	...
	namespace engine
	{
		...
		bool TextPreprocessor::preprocess(const string& inputFilename)
		{
			...
			cout << "----------------------------------------------------------------------" << endl;
			cout << "1) Preprocessing for " << getEngine().getAnnotator().getMailIdAsString() << " (" << inputFilename << ")" << endl;
			cout << "----------------------------------------------------------------------" << endl;
#endif
...
#ifdef DEBUG_UIMA_CPP
			cout << "----------------------------------------------------------------------" << endl;
			cout << "End of preprocessing for " << getEngine().getAnnotator().getMailIdAsString() << endl;
			cout << "----------------------------------------------------------------------" << endl;
#endif
			return true;
		}
